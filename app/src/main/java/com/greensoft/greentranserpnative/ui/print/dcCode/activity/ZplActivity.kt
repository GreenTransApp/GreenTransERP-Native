...
import com.greensoft.greentranserpnative.databinding.ActivityZplBinding
...
class ZplActivity : AppCompatActivity() {
    ...
    private lateinit var activityBinding: ActivityZplBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        activityBinding = ActivityZplBinding.inflate(layoutInflater)
    ...
    private fun initClick() {
        ...
        activityBinding.customFontBtn.setOnClickListener {
        ...
        activityBinding.sampleBtn.setOnClickListener {
            printer.addStart()
        ...
        activityBinding.barcode2Btn.setOnClickListener {
            printer.addStart()
                .addText(0, 0, "CODABAR")
