...
class CustomerCodeSelectionRepository  @Inject constructor(): BaseRepository() {
    ...
    fun getCustomerList( companyId:String,userCode:String,branchCode:String,sessionId:String,menuCode:String,charStr:String) {
        ...
        api.getCustomerList(companyId,userCode, branchCode,sessionId,menuCode,charStr).enqueue(object:
