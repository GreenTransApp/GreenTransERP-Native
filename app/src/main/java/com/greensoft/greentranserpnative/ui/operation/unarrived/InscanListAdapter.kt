...
class InscanListAdapter (private val inscanList: ArrayList<InscanListModel>,
private val onRowClick: OnRowClick<Any>) :
RecyclerView.Adapter<InscanListAdapter.InscanViewHolder>() , Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): InscanViewHolder {
        ...
        return InscanListAdapter.InscanViewHolder(binding)
    }
