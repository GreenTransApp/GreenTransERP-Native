...
class CustomerSelectionAdapter @Inject constructor(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val layoutBinding = ItemCustomerSelectionBinding.inflate(inflater,parent,false)
    ...
    inner class CustomerSelectionViewHolder(
        private val layoutBinding: ItemCustomerSelectionBinding,
