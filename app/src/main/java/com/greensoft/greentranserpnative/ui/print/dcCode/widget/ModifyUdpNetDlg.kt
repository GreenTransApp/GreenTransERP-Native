package com.greensoft.greentranserpnative.ui.print.dcCode.widget
...
import com.greensoft.greentranserpnative.databinding.DlgModifyUdpNetBinding
...
//            it.decorView.findViewById<View>(R.id.title).visibility = View.GONE
    ...
    private fun modify() {
        try {
            ...
            POSPrinter.udpNetConfig(device.macAddress, ip, mask, gateway, dhcp)
        } catch (e: Exception) {
            e.printStackTrace()
