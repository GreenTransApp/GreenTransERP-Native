...
import com.greensoft.greentranserpnative.databinding.ActivitySelectBlutoothBinding
...
class SelectBluetoothActivity : AppCompatActivity() {
    private lateinit var activityBinding: ActivitySelectBlutoothBinding
    private val GPS_ACTION = "android.location.PROVIDERS_CHANGED"

    companion object {
        const val INTENT_MAC = "MAC"
        const val INTENT_BT_NAME = "BT_NAME"
    }
        ...
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND == action) {
                ...
                if (btd!!.bondState != BluetoothDevice.BOND_BONDED && !deviceIsExist(btd.address)) {
                    ...
                    activityBinding.recyclerView.adapter?.notifyItemChanged(datas.size - 1)
                }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityBinding = ActivitySelectBlutoothBinding.inflate(layoutInflater)
        ...
        adapter.itemClick = {
            ...
            intent.putExtra(INTENT_BT_NAME, datas[it].name)
    ...
    private fun initClick() {
        activityBinding.refreshTv.setOnClickListener {
            requestPermission()
        }
    }
    ...
    private fun searchDevices() {
        ...
        activityBinding.recyclerView.adapter?.notifyDataSetChanged()
