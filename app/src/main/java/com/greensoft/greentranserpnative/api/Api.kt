...
//        @Field("prmgrno")prmgrno :String ,
 ...
 @GET("PODAPI/showpoddetails")
  ...
  @FormUrlEncoded
    ...
    @FormUrlEncoded
    @POST("BookingAPI/JeenaBookingWithoutIntent")
    fun SaveDirectBooking(
        @Field("prmconnstring") companyId: String?,
        @Field("prmbranchcode")    branchcode :String?,
        @Field("prmbookingdt")    bookingdt :String?,
        @Field("prmtime")    time :String?,
        @Field("prmegrno")    egrno :String?,
        @Field("prmcustcode")    custcode :String?,
        @Field("prmdestcode")    destcode :String?,
        @Field("prmproductcode")    productcode :String?,
        @Field("prmpckgs")    pckgs :Int?,
        @Field("prmaweight")    aweight :String?,
        @Field("prmvweight")    vweight :String?,
        @Field("prmcweight")    cweight :String?,
        @Field("prmcreateid")    createid :String?,
        @Field("prmsessionid")    sessionid :String?,
        @Field("prmrefno")    refno :String?,
        @Field("prmcngr")    cngr :String?,
        @Field("prmcngraddress")    cngraddress :String?,
        @Field("prmcngrcity")    cngrcity :String?,
        @Field("prmcngrzipcode")    cngrzipcode :String?,
        @Field("prmcngrstate")    cngrstate :String?,
        @Field("prmcngrmobileno")    cngrmobileno :String?,
        @Field("prmcngremailid")    cngremailid :String?,
        @Field("prmcngrCSTNo")    cngrCSTNo:String?,
        @Field("prmcngrLSTNo")    cngrLSTNo:String?,
        @Field("prmcngrTINNo")    cngrTINNo:String?,
        @Field("prmcngrSTaxRegNo")    cngrSTaxRegNo:String?,
        @Field("prmcnge")    cnge :String?,
        @Field("prmcngeaddress")    cngeaddress :String?,
        @Field("prmcngecity")    cngecity :String?,
        @Field("prmcngezipcode")    cngezipcode :String?,
        @Field("prmcngestate")    cngestate :String?,
        @Field("prmcngemobileno")    cngemobileno :String?,
        @Field("prmcngeemailid")    cngeemailid :String?,
        @Field("prmcngeCSTNo")    cngeCSTNo:String?,
        @Field("prmcngeLSTNo")    cngeLSTNo:String?,
        @Field("prmcngeTINNo")    cngeTINNo:String?,
        ...
        @Field("prmtempuraturestr")    tempuraturestr :String?,
        @Field("prmpackingstr")    packingstr :String?,
        @Field("prmgoodsstr")    goodsstr :String?,
        @Field("prmdryicestr")    dryicestr :String?,
        @Field("prmdryiceqtystr")    dryiceqtystr :String?,
        @Field("prmdataloggerstr")    dataloggerstr :String?,
        @Field("prmdataloggernostr")    dataloggernostr :String?,
        @Field("prmdimlength")    dimlength :String?,
        @Field("prmdimbreath")    dimbreath :String?,
        @Field("prmdimheight")    dimheight :String?,
        @Field("prmpickupboyname")    pickupboyname :String?,
        @Field("prmboyid")    boyid :Int?,
        @Field("prmboxnostr")    boxnostr :String?,
        @Field("prmstockitemcodestr")    stockitemcodestr :String?,
        @Field("prmgelpackstr")    gelpackstr :String?,
        @Field("prmgelpackitemcodestr")    gelpackitemcodestr :String?,
        @Field("prmgelpackqtystr")    gelpackqtystr :String?,
        @Field("prmmenucode")    menucode :String?,
        @Field("prminvoicenostr")    invoicenostr :String?,
        @Field("prminvoicedtstr")    invoicedtstr :String?,
        @Field("prminvoicevaluestr")    invoicevaluestr :String?,
        @Field("prmewaybillnostr")    ewaybillnostr :String?,
        @Field("prmewaybilldtstr")    ewaybilldtstr :String?,
        @Field("prmewbvaliduptodtstr")    ewbvaliduptodtstr :String?,
        @Field("prmvendorcode")    vendorcode :String?,
        @Field("prmpckgsstr")    pckgsstr :String?,
        @Field("prmpickupby")    pickupby :String?,
        @Field("prmvehicleno")    vehicleno :String?,
        @Field("prmvweightstr")    vweightstr :String?,
        @Field("prmvehiclecode")    vehiclecode :String?,
        @Field("prmcngrcode")    cngrcode :String?,
        @Field("prmcngecode")    cngecode :String?,
        @Field("prmremarks")    remarks :String?,
        @Field("prmcngrgstno")    cngrgstno :String?,
        @Field("prmcngegstno")    cngegstno :String?,
        @Field("prmcngrtelno")    cngrtelno :String?,
        @Field("prmcngetelno")    cngetelno :String?,
        @Field("prmorgpincode")    orgpincode :String?,
        @Field("prmdestpincode")    destpincode :String?,
        @Field("prmpickuppoint")    pickuppoint :String?,
        @Field("prmdeliverypoint")    deliverypoint :String?,

        ) : Call<CommonResult>
    @GET("WMS/ERPNATIVE_GrListForPOD")
    fun getPendingGrListForDelivery(
        @Query("prmconnstring") companyId: String,
        @Query("prmusercode") userCode:String?,
        @Query("prmbranchcode") branchCode:String?,
        @Query("prmmenucode") menuCode: String?,
